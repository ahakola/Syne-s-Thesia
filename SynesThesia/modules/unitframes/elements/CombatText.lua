...
local Update = function(self, event, unit, combatEvent, flags, amount, school)
	...
	local color = element.colors[combatEvent] or (element.customDefault and element.colors.DEFAULT or colors[combatEvent]) or colors.DEFAULT -- Modified by ahak to support external edit of colors
...
local Enable = function(self)
	...
	element.colors = element.colors or colors -- Modified by ahak to support external edit of colors
	element.customDefault = element.customDefault or false -- Modified by ahak to determine whether we use external DEFAULT or hardcoded colors if key is missing from external colors
